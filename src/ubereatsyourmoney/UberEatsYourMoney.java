...
public class UberEatsYourMoney {
    ...
    public static UberEatsTotals getUberEatsTotals(Gmail service) throws IOException {
        ...
        List<Message> uberEatsMessages = GmailHandler.getUberEatsMessages(duration.toDays(), service);
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        TimerNightlyUpdate.startTask(gui, service);
